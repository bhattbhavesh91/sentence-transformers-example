# Sentence Similarity using HuggingFace's Sentence Transformers v2
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bhattbhavesh91/sentence-transformers-example/blob/main/sentence-transformer-notebook.ipynb)

## To view the video

<table>
   <tr>
      <td><a href="http://www.youtube.com/watch?v=iBY-PqJAAsU" target="_blank"><img height="50" src = "https://img.shields.io/youtube/views/iBY-PqJAAsU?color=blue&label=Watch%20on%20YouTube&logo=youtube&logoColor=red&style=for-the-badge"></a></td>
   </tr>
</table>
...
[![Sentence Similarity using HuggingFace's Sentence Transformers v2
](http://img.youtube.com/vi/iBY-PqJAAsU/0.jpg)](http://www.youtube.com/watch?v=iBY-PqJAAsU)
